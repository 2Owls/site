...
export default function Model(props) {
  ...
  const texture1 = useLoader(TextureLoader, '/homera_wallpaper.jpeg')
  ...
  const texture2 = useLoader(TextureLoader, '/homera_cube_pic.png')
        ...
        <group position={[0, 0, 0]}>
          <group position={[-11.16, 55.02, -70.55]} rotation={[0.01, -1.57, 0]}
            ...
            <mesh
              ...
              position={[0, 0, 0]}
              >
              <meshStandardMaterial map={texture2} map-flipY={false} />  
            </mesh>
            <mesh
              castShadow
              receiveShadow
